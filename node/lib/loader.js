...
function build(libPath) {
  ...
  return {
    ...
    fns: {
      ...
      scanio_order_by: lib.func('void *scanio_order_by(void *, size_t, int)'),
      scanio_order_by_next: lib.func('int scanio_order_by_next(void *, _Out_ void **, _Out_ size_t *)'),
      scanio_order_by_close: lib.func('void scanio_order_by_close(void *)'),
